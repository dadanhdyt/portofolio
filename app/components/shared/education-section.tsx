...
export default function Education() {
  return (
    <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
      <div className="hover:bg-background-800  ring-background-200 bg-primary-100 hover:ring-primary-200 ring-1 rounded-lg">
        <div className="p-2 gap-3 flex">
          ...
          <div className="flex flex-col cursor-pointer items-start justify-center">
            <span className="text-1xl sm:text-xl text-text-950 font-bold">
              REKAYASA PERANGKAT LUNAK
            </span>
            <span className="text-sm md:text-lg text-text-700">
